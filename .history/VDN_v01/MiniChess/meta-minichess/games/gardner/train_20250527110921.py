...
from config import DEVICE, ALPHA, STEP_COST, HIDDEN_CHANNELS, num_cycles, games_per_cycle, iterations_MCTS, num_epochs, batch_size, learning_rate, weight_decay, arena_games

# Ripristino della funzione compute_material_potential
# In assenza di un modulo dedicate, la ridefiniamo qui:
